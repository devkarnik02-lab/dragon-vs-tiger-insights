...
function DownloadButton({
  ...
  const cls = size === "lg" ? "w-full py-5 text-xl md:text-2xl" : "py-4 px-8 text-lg";
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                ...
                left: "-10%",
                borderRadius: "50%",
                background: "radial-gradient(circle, rgba(245,197,66,0.18) 0%, rgba(0,200,83,0.1) 50%, transparent 70%)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                ...
                right: "-10%",
                borderRadius: "50%",
                background: "radial-gradient(circle, rgba(0,200,83,0.15) 0%, rgba(245,197,66,0.08) 50%, transparent 70%)"
              }
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-2xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              style: { color: "#00c853" },
              children: "🎮 India's Fastest Growing Rummy App"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl sm:text-5xl md:text-6xl font-black leading-tight mb-5 gold-gradient-text", children: "Get ₹101 Welcome Bonus 🎁" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg sm:text-xl text-white/80 mb-6 font-medium", children: "Download the app & start playing instantly" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap justify-center gap-3 mb-10 text-sm font-semibold", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(DownloadButton, { size: "lg" })
          ] })
        ] })
      ]
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-float-phone", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              ...
              boxShadow: "0 0 60px rgba(245,197,66,0.2), 0 40px 80px rgba(0,0,0,0.6)",
              overflow: "hidden"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-xs font-semibold", children: "9:41" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-black text-lg", style: { color: "#f5c542" }, children: "RummyLoot" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-white/50 mb-1", children: "Wallet Balance" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-black", style: { color: "#f5c542" }, children: "₹101.00" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1", style: { color: "#00c853" }, children: "+₹101 Welcome Bonus" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 mt-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-white/40 mb-2", children: "Active Tables" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [
                  ["♠", "Points Rummy", "₹10/entry", "12"],
                  ["♥", "Pool Rummy", "₹25/entry", "8"]
                ].map(([suit, name, entry, players]) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg", children: suit }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-white", children: name }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "#f5c542" }, children: entry })
                        ] })
                      ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: ["🏠", "🎮", "🏆", "👤"].map((icon) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl", children: icon }, icon))
                }
              )
            ]
          }
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h2",
          {
            className: "text-2xl sm:text-3xl font-bold text-center mb-12",
            style: { color: "#f5c542" },
            children: "Why Players Love Us"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4 max-w-2xl mx-auto", children: FEATURES.map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-white text-sm sm:text-base mb-2", children: f.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs sm:text-sm text-white/50", children: f.desc })
            ]
          },
          f.title
        )) })
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h2",
          {
            ...
            style: { color: "#f5c542" },
            children: "Ready to Win Big?"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 mb-10 text-lg", children: "Start with ₹101 free — no deposit needed" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md mx-auto flex flex-col items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: "animate-badge text-xs font-black uppercase tracking-wider px-4 py-1.5 rounded-full",
...
function SocialProofSection() {
  const stats = [
    { target: 5e4, prefix: "", suffix: "+", label: "Users Joined" },
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h2",
          {
            className: "text-2xl sm:text-3xl font-bold text-center mb-12",
            style: { color: "#f5c542" },
            children: "Join Thousands of Players"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-4 max-w-2xl mx-auto", children: stats.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-glow rounded-2xl p-5 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "text-2xl sm:text-3xl font-black mb-2",
              style: { color: i === 1 ? "#00c853" : "#f5c542" },
              children: s.display ? s.display : /* @__PURE__ */ jsxRuntimeExports.jsx(
                AnimatedCounter,
                {
                  target: s.target,
                  prefix: s.prefix,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-white/50", children: s.label })
        ] }, s.label)) })
      ]
    }
  );
...
function useCountdown() {
  const [time, setTime] = reactExports.useState({ h: 23, m: 59, s: 59 });
  reactExports.useEffect(() => {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 mb-8", children: "₹101 Welcome Bonus expires in:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center gap-3 mb-8", children: [
              [pad(h), "HRS"],
              [pad(m), "MIN"],
              [pad(s), "SEC"]
            ].map(([val, label]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-white/40 mt-1 tracking-widest", children: label })
            ] }, label)) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: "Claim Before It Expires"
              }
            )
          ]
        }
...
function FloatingNotifications() {
  ...
  const addNotif = reactExports.useCallback(() => {
    ...
    const type = Math.random() > 0.4 ? "won" : "joined";
    const notif = { id, name, amount, type, leaving: false };
    setNotifs((prev) => [...prev.slice(-2), notif]);
    setTimeout(() => {
      setNotifs(
        (prev) => prev.map((n) => n.id === id ? { ...n, leaving: true } : n)
      );
      setTimeout(
  ...
  reactExports.useEffect(() => {
    const schedule = () => {
      const delay = 4e3 + Math.random() * 4e3;
      return setTimeout(() => {
        addNotif();
        schedule();
      }, delay);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-24 left-4 z-40 flex flex-col gap-2", children: notifs.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-white leading-snug", children: n.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: "text-xs",
              style: { color: n.type === "won" ? "#00c853" : "#f5c542" },
              children: n.type === "won" ? `just won ${n.amount}` : "just joined 🎉"
            }
          )
        ] })
      ]
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "footer",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/40 text-xs mb-2", children: "⚠️ Play responsibly. This app is for entertainment purposes only." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/30 text-xs mb-4", children: "This platform is for users 18+ only. No guaranteed winnings. Participation at own risk." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/25 text-xs", children: [
          "© ",
          year,
          ". Built with ❤️ using",
          " ",
